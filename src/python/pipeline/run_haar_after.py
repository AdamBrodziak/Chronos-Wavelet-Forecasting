"""
Pipeline: Haar-after — Dekompozycja Haar → złożenie wybranych poziomów → predykcja.

Z kombinacje-mozliwosci:
  dane wejściowe → dekompozycja dyskretna Haar
  → wybranie poziomów do dekompozycji Haar'a
  → złożenie wielu sygnałów z wybranych poziomów
    (eliminacja innych poziomów — każdy wybrany poziom
     ma swój sygnał w oryginalnej dziedzinie czasu)
  → Chronos 2 → predykcja
